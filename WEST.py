...
#AUTHOR : CHIGOZIEWORLDWIDE (WEST)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO WEST
...
agents = [
					"Mozilla/5.0 (Linux; Android 11; TECNO LE7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36;]",
					...
					"Mozilla/5.0 (Linux; Android 11; TECNO LE7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36;]",
					"Mozilla/5.0 (Linux; Android 11; TECNO KF7j) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.50 Mobile Safari/537.36",
...
header = {"user-agent": '[Mozilla/5.0 (Linux; Android 4.1.2; Nokia_XL Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.82 Mobile Safari/537.36 NokiaBrowser/1.2.0.12;]',
...
"""
CorrectUsername = "WEST"
CorrectPassword = "WEST"
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/CHIGOZIEWORLDWIDE")
			os.system("rm -rf WEST")
			os.system("cp -f WEST/WEST.py \\.")
			os.system("rm -rf WEST")
